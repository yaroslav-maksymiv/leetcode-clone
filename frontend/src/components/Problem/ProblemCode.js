...
const ProblemCode = ({code, setCode, problemData}) => {
    ...
    return (
        <div
            ...
            <div style={{'background': '#1e1e1e'}} className="layout-block__content flex-grow overflow-auto h-full">
                <div style={{'background': '#1e1e1e'}}
                    ...
                    <div className="layout-block__languages relative">
                        <button
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <Popup className="editor-settings-popup" open={isEditorPopupOpen} closeOnDocumentClick
                            ...
                            <div className="bg-zinc-800 shadow-2xl text-white rounded-md">
                                <div className="text-2xl text-center border-b border-zinc-700 p-4">Editor Settings</div>
                                <div className="p-4">
            ...
            <div
                ...
                <div className="text-xs text-gray-500">Saved to local</div>
            </div>
        </div>
    )
}
